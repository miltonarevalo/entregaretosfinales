...
public class ForrmActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forrm);
    ...
    public void Eliminar(View view){
        ...
        if(!codigo.isEmpty()){
            ...
            Toast.makeText(this, "Debe de introducir el código del artículo", Toast.LENGTH_SHORT).show();
        }
    }
